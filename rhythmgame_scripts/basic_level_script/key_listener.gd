...
@onready var falling_key = preload("res://rhythmgame_scenes/basic_level_scene/falling_key.tscn")     # The falling note prefab
@onready var score_text = preload("res://rhythmgame_scenes/basic_level_scene/score_press_text.tscn") # The floating score text prefab
...
func GameOver():
	...
	get_tree().change_scene_to_file("res://rhythmgame_scenes/endingScreen_scene/game_over.tscn")
