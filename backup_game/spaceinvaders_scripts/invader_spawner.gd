...
func _ready():
	...
	var invader_1_res = preload("res://spaceinvaders_resources/invader_1.tres")
	var invader_2_res = preload("res://spaceinvaders_resources/invader_2.tres")
	var invader_3_res = preload("res://spaceinvaders_resources/invader_3.tres")
	invader_scene = preload("res://spaceinvaders_scenes/characters/invader.tscn")	
